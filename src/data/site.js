...
export const ATHLETES = [
  ...
  // Athletes from results archive — added from Google Sites data
  {
    id: 'iacopo-brasi',
    name: 'Iacopo Brasi',
    specialty: 'Corsa in montagna / Maratona',
    palmares: '1° Cimbergo-Volano 2021, 1° Forte Corno Run 2024, 2° Maratona Lanzarote 2022',
    born: 1994,
    badges: [
      { type: 'vittoria', label: '1° Cimbergo-Volano 2021' },
      { type: 'vittoria', label: '1° Forte Corno Run 2024' },
      { type: 'vittoria', label: '2° Maratona Lanzarote 2022' },
    ],
  },
  {
    id: 'ilaria-bianchi',
    name: 'Ilaria Bianchi',
    specialty: 'Corsa in montagna / Vertical',
    palmares: 'Vice campionessa italiana KV 2018, 3a nazionale KV 2020, 1a Sri Chinmoy 2023',
    born: 1992,
    badges: [
      { type: 'tricolore', label: 'Vice Campionessa Italiana KV 2018' },
      { type: 'tricolore', label: '3a Nazionale KV 2020' },
      { type: 'vittoria', label: '1a Maratonina Lemine 2022' },
    ],
  },
  {
    id: 'eliana-patelli',
    name: 'Eliana Patelli',
    specialty: 'Maratona / Mezza maratona',
    palmares: 'Campionessa italiana SF40 Maratona 2019, 1a Mezza Maratona Verona 2018',
    born: 1979,
    badges: [
      { type: 'tricolore', label: 'Campionessa Italiana SF40 2019' },
      { type: 'vittoria', label: '1a Mezza Maratona Verona 2018' },
    ],
  },
  {
    id: 'pietro-lenzi',
    name: 'Pietro Lenzi',
    specialty: 'Vertical / Corsa in montagna',
    palmares: '1° 521 Vertical 2018, 1° Vall\'Adame Vertical, 1° Poker della Montagna',
    born: 1993,
    badges: [
      { type: 'vittoria', label: '1° 521 Vertical 2018' },
      { type: 'vittoria', label: '1° Vall\'Adame Vertical' },
    ],
  },
  {
    id: 'marco-tiraboschi',
    name: 'Marco Tiraboschi',
    specialty: 'Maratona',
    palmares: '1° assoluto Maratona Sanremo 2019 (2:42:42 PB)',
    born: 1980,
    badges: [
      { type: 'vittoria', label: '1° Maratona Sanremo 2019' },
    ],
  },
  {
    id: 'ivan-angiolini',
    name: 'Ivan Angiolini',
    specialty: 'Corsa su strada / Duathlon',
    palmares: 'Campione circuito Fosso Bergamasco 2024, 1° Costa de Corsa 2023',
    born: 1985,
    badges: [
      { type: 'vittoria', label: 'Campione Fosso Bergamasco 2024' },
      { type: 'vittoria', label: '1° Costa de Corsa 2023' },
    ],
  },
  {
    id: 'roberto-cassol',
    ...
    palmares: '1° Restena Trail 2022, staffetta Trofeo Vanoni 2020',
    born: 1997,
    badges: [
      { type: 'vittoria', label: '1° Restena Trail 2022' },
    ],
  },
  {
    id: 'marco-zanga',
    name: 'Marco Zanga',
    specialty: 'Corsa in montagna',
    palmares: '1° assoluto Monte Rena Running 2024',
    born: 1995,
    badges: [
      { type: 'vittoria', label: '1° Monte Rena Running 2024' },
    ],
  },
  {
    id: 'katia-nana',
    ...
    palmares: '1a assoluta Mini Reguzzo Skyrace 2021',
    born: 1990,
    badges: [
      { type: 'vittoria', label: '1a Mini Reguzzo Skyrace 2021' },
    ],
  },
  {
    id: 'mattia-tiraboschi',
    name: 'Mattia Tiraboschi',
    specialty: 'Corsa in montagna',
    palmares: '2° Monte Rena Running 2024',
    born: 1999,
    badges: [],
  },
  {
    ...
    name: 'Davide Scolari',
    specialty: 'Corsa in montagna',
    palmares: '3° Monte Rena Running 2024',
    born: 1995,
    badges: [],
  },
  {
    id: 'francesco-bongio',
    name: 'Francesco Bongio',
    specialty: 'Ultra trail',
    palmares: '1° assoluto Lavaredo Ultra Trail 10km 2024',
    born: 1996,
    badges: [
      { type: 'vittoria', label: '1° Lavaredo Ultra Trail 10km' },
    ],
  },
  {
    id: 'simone-tampini',
    name: 'Simone Tampini',
    specialty: 'Trail running',
    palmares: '3° Trail di Portofino 2022',
    born: 1993,
    badges: [],
  },
  {
    ...
    specialty: 'Trail running',
    palmares: '7° Monte Misma Xmas Trail 2023',
    born: 1992,
    badges: [],
  },
  {
    id: 'alessandro-zanga',
    name: 'Alessandro Zanga',
    specialty: 'Corsa in montagna',
    palmares: '2° Forte Corno Run 2024',
    born: 1997,
    badges: [],
  },
];
...
export const BLOG_POSTS = [
  {
    ...
    results: [
      ...
      {
        athlete: 'Andrea Elia',
        athleteId: 'andrea-elia',
        race: 'Trail del Resegone',
        location: 'Lecco',
        text: 'Terzo posto in una gara combattutissima sui sentieri fangosi del Resegone. Il doppio campione italiano di sola salita e vertical dimostra di essere in forma anche sul trail tecnico. Ottimo test a cinque settimane dal Memorial Peket.',
        position: 3,
      },
      {
        ...
        race: 'Trail del Resegone',
        location: 'Lecco',
        text: 'Quinta tra le donne, prima bergamasca. La campionessa italiana di vertical conferma la polivalenza sulle distanze trail. "Sentieri bellissimi nonostante il fango, mi sono divertita."',
        position: 5,
      },
      {
        athlete: 'Isacco Costa',
        athleteId: 'isacco-costa',
        race: 'Test Cronometrico Gazzaniga-Orezzo',
        location: 'Gazzaniga',
        text: 'Test interno sul percorso storico Gazzaniga-Orezzo in preparazione al Memorial Peket del 25 aprile. Il campione italiano ha chiuso con il miglior tempo davanti a Luca Magri e Luciano Rota. La forma c\'e.',
        position: 1,
      },
    ],
  },
